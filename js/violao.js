...
function makeSound(key){
    switch (key) {
        case "w":
        var tom1 = new Audio ("sounds/violao/corda1.mp3")
        tom1.play();
        break;
    case "a":
        var tom2 = new Audio ("sounds/violao/corda2.mp3")
        tom2.play();
        break;
    case "s":
        var tom3 = new Audio ("sounds/violao/corda3.mp3")
        tom3.play();
        break;
    case "d":
        var tom4 = new Audio ("sounds/violao/corda4.mp3")
        tom4.play();
        break;
    case "j":
        var snare = new Audio ("sounds/violao/corda5.mp3")
        snare.play();
        break;
    case "k":
        var crash = new Audio ("sounds/violao/corda6.wav")
        crash.play();
        break;
    default:
        console.log("erro");
